...
public class ConfigRegistry {
    ...
    public static ForgeConfigSpec.BooleanValue
            OPEN_FOOD_WATER_LEVEL, OPEN_WATER_SATURATION_LEVEL, IS_DEBUG_MODE, DISABLE_FILTER_STRAINER_HUD, DISABLE_ALL_WATER_LEVEL_BAR,
    ...
    static {
        ...
        DISABLE_FILTER_STRAINER_HUD = COMMON_BUILDER.comment(" ","Disable water filter strainer HUD.", "Default:false").translation("watersource.config.disableFilterStrainerHUD").define("disableFilterStrainerHUD", false);
        DISABLE_ALL_WATER_LEVEL_BAR = COMMON_BUILDER.comment(" ","Disable All water level HUD!", "Default:false").translation("watersource.config.disableAllWaterLevelBar").define("disableAll", false);
        COMMON_BUILDER.pop();
